...
export function venueStatusInfo(status: Pick<SiteStatus['venue'], 'mode' | 'isOpen'> | undefined): { label: string; tone: StatusTone; pulse: boolean } {
...
export function StatusPill() {
  ...
  return (
    <Link
      ...
      aria-label={`Режим работы: ${info.label}`}
      className={cn(
